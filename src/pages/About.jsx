    ...
    <div className="page-wrapper" style={{ padding: '6rem 1rem 4rem' }}>
      <div className="container" style={{ maxWidth: 800 }}>
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <h1 style={{ fontFamily: 'var(--font-heading)', color: 'var(--neon)', fontSize: '3rem', marginBottom: '1rem', textTransform: 'uppercase' }}>About Bhima Esports</h1>
          <p style={{ color: 'var(--text-muted)', fontSize: '1.2rem', lineHeight: 1.6, marginBottom: '2rem' }}>
            We are the ultimate collegiate and professional esports management platform, dedicated to elevating the competitive gaming experience to a Tier-1 standard.
          </p>
